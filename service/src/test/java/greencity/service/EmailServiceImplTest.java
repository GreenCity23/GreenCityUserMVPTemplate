...
class EmailServiceImplTest {
    ...
    public void setup() {
        ...
        when(userRepo.findByEmail(anyString())).thenReturn(Optional.ofNullable(ModelUtils.getUser()));
    }
    ...
    void sendChangePlaceStatusEmailTest() {
        ...
        service.sendChangePlaceStatusEmail(authorFirstName, placeName, placeStatus, "test@gmail.com");
